package com.ProyectoIntegrador.controllers.impl;

import com.ProyectoIntegrador.exceptions.BadRequestException;
import com.ProyectoIntegrador.exceptions.GlobalExceptionsHandler;
...
import com.ProyectoIntegrador.utils.Mapper;
...
public class OdontologoControllerTests {
    ...
    public void reset() throws BadRequestException, ResourceNotFoundException {
        mockMvc = MockMvcBuilders.standaloneSetup(odontologoController).setControllerAdvice(
                GlobalExceptionsHandler.class).build();
        odontologo = new OdontologoDto(123456789, "Harry", "Postre", 123456);
        odontologoInexistente = new OdontologoDto(123456789, "Harry", "Postre", 123456);
        odontologoExistente = new OdontologoDto(123456789, "Harry", "Postre", 123456);
    ...
    public void configureMockito() throws BadRequestException, ResourceNotFoundException {
        ...
        Mockito.when(odontologoService.buscar("Harry")).thenReturn(List.of(odontologoExistente));
