...
public class PacienteControllerTests {
    ...
    public void reset() throws BadRequestException, ResourceNotFoundException {
        mockMvc = MockMvcBuilders.standaloneSetup(pacienteController).setControllerAdvice(
        ...
        pacienteInexistente = new PacienteDto("Harry", "Potter", 123456789, domicilioConId);
        pacienteExistente = new PacienteDto("Harry", "Potter", 123456789, domicilioConId);
    ...
    public void configureMockito() throws BadRequestException, ResourceNotFoundException {
        ...
        Mockito.when(pacienteService.buscar("Harry")).thenReturn(List.of(pacienteExistente));
